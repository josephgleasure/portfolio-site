...
const project: Project = {
  ...
  tags: ["AI"],
  description: "Ghostwritten thought leadership content developed through consultative interviews with Jason Liu, AI engineer and consultant. Through a series of conversations, we transformed Jason's expertise on AI startup hiring practices into strategic content designed to drive soft inbound leads. The goal was threefold: demonstrate Jason had already considered his clients' challenges, showcase proven solutions to common problems, and reinforce his positioning as an AI industry thought leader. This piece exemplifies our shared philosophy of converting lived experience into educational content that builds authority while attracting ideal consulting clients organically.",
